  ...
  <VerticalNavLayout :nav-items="navItems">
    ...
    <template #navbar="{ toggleVerticalOverlayNavActive }">
      <div class="d-flex h-100 align-center">
        ...
        <VSpacer />
        <NavbarShortcuts class="me-1 short-cut" style="margin-right: 20px" />
        <div
          class="hotline d-flex"
          style="align-items: center; margin-right: 20px; margin-left: 20px"
        >
          ...
          <div>
            <div>Hotline miễn phí</div>

            <div class="phone_number">
              <a title="hotline" href="tel:1800 6024">1800 6024</a>
            </div>
          </div>
        </div>
        ...
        <div v-else>
        <VBtn :to="{path: '/login'}">Đăng nhập</VBtn>
        </div>
      </div>
    </template>
