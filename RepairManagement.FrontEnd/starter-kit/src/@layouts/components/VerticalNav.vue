      ...
      <slot name="nav-header">
        ...
        >
          ...
          <Transition name="vertical-nav-app-title">
            ...
            <img class="logo_img_small" width="175" src="https://suachualaptop24h.com/images/config/2-01-mobile_1708740113.png" alt="Suachualaptop24h - Số 1 về dịch vụ sửa chữa laptop">
          </Transition>
        </RouterLink>
